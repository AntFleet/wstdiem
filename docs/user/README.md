...
Welcome to wstDIEM Looping. This guide is for retail users who hold wstDIEM and want to open a leveraged position, monitor it, and exit when ready.

**No jargon, no technical prerequisites. Just step-by-step instructions and plain-English explanations of the risks you carry.**
...
- **Wallets** — which wallets work (MetaMask, Safe, Coinbase Smart Wallet)
- **FAQ** — answers to the questions we hear most often
- **Glossary** — definitions of terms you'll see in the UI
