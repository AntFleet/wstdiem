...
- enforce `equityCollateral`, `minWstDiemReceived`, `minBorrowedDiem`, `maxBorrowedDiem`, `maxSlippageBps`, `maxPriceImpactBps`, `maxLeverageBps`, `minHealthFactor`, `minLiquidationDistanceBps`, `maxMorphoUtilizationImpactBps`, `deadline`, and the §6.4 nonce slot/bit.
...
- `Open`: `equityCollateral`, `minWstDiemReceived`, `minBorrowedDiem`, `maxBorrowedDiem`, `maxSlippageBps`, `maxPriceImpactBps`, `maxLeverageBps`, `minHealthFactor`, `minLiquidationDistanceBps`, `maxMorphoUtilizationImpactBps`, `flashFeeCap`, `protocolFeeCap`, `automationFeeCap`. (`maxCurvePositionShareBps` is omitted from `Open` because Phase 1 open does not invoke Curve.)
